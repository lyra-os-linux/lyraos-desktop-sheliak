...
if (Gio.File.new_for_path(localePath).query_exists(null)) {
    Gettext.bindtextdomain('lyra-desktop-icons', localePath);
}
...
const dingApp = new Gtk.Application({
    application_id: asDesktop ? 'br.com.lyraos.desktopicons' : 'br.com.lyraos.desktopicons.test',
